...
const runEngine = () => {
  console.log('🧠 Iniciando IA: Ajustando ratings con resultados reales...');
  ...
  // 2. Borrar predicciones SOLO de los partidos que NO han terminado (para usar la nueva inteligencia)
  ...
  // 3. Crear predicciones para TODOS los partidos que no tengan una en la BD (incluye los terminados que se quedaron en blanco)
  ...
  console.log('✅ Base de datos actualizada con nuevas probabilidades.');
};
